...
The Laser Interface node has a number of parameters accessible via the UAVCAN interface. These may be set following the steps outlined [here](https://github.com/avionicsanonymous/avionicsanonymous.github.io/tree/ac373715ae6f24b32783af4343ed682053330f11/devices/general/parameters.md)
